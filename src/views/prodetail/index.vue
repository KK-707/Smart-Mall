      ...
      >
        <div class="product">
          ...
          <div class="showbtn" v-if="detail.stock_total > 0">
            ...
            <div class="btn" v-if="mode === 'buyNow'" @click="goBuyNow">
              立刻购买
            </div>
          </div>
...
import defaultImg from '@/assets/image/default-avatar.png'
import CountBox from '@/components/CountBox.vue' // 使用子组件
import { addCart } from '@/api/cart'
import loginConfirm from '@/mixins/loginConfirm' // 导入混入方法
...
export default {
  ...
  computed: {
    goodsId() {
      // this.$route.params 是一个对象，它包含了当前路由的参数
